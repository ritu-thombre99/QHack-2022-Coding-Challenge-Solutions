...
def error_wire(circuit_output):
    ...
    q0,q1,q2 = circuit_output[0],circuit_output[1],circuit_output[2]
    error_readout = None
    if q1[0] == q2[0] and q1[1] == q2[1]:
        error_readout = [q1[0],q1[1],0.,0.]
    elif q2[1] > 0.:
        error_readout = [q2[0],0.,0.,q2[1]]
    elif q1[1] > 0.:
        error_readout = [q1[0],0.,q1[1],0.]
    return np.array(error_readout, dtype=float).numpy()
    # QHACK #
